...
PYBIND11_MODULE(plantbox, m) {
    ...
    py::class_<RectilinearGrid3D, SoilLookUp, std::shared_ptr<RectilinearGrid3D>>(m, "RectilinearGrid3D")
			...
			.def("getData", py::overload_cast<size_t, size_t, size_t>(&RectilinearGrid3D::getData))
                        .def("getData", py::overload_cast<size_t>(&RectilinearGrid3D::getData))
			.def("setData", py::overload_cast<size_t, size_t, size_t, double>(&RectilinearGrid3D::setData))
                        .def("setData", py::overload_cast<size_t, double>(&RectilinearGrid3D::setData))
